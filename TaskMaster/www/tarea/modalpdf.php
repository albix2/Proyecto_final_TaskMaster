  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="pdf_<?php echo $registro['id']; ?>">Modal title</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <a href="pdf.php?id=<?php echo $registro['id']; ?>"><i class="bi bi-file-earmark-pdf" style="font-size: 2rem; color:black;"></i></a>
          </div>
        </div>
        <?php
        } else {
